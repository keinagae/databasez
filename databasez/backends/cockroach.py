...
from databasez.backends.dialects.cockroach import dialect as cockroach_dialect
...
class CockroachBackend(DatabaseBackend):
    def __init__(
    ...
    def _get_dialect(self) -> Dialect:
        dialect = cockroach_dialect(paramstyle="pyformat")
    ...
    def connection(self) -> "CockroachConnection":
        return CockroachConnection(self, self._dialect)


class CockroachConnection(ConnectionBackend):
    def __init__(self, database: CockroachBackend, dialect: Dialect):
    ...
    def transaction(self) -> TransactionBackend:
        return CockroachTransaction(connection=self)
...
class CockroachTransaction(TransactionBackend):
    def __init__(self, connection: CockroachConnection):
